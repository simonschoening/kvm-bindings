...
pub union kvm_run__bindgen_ty_1 {
    ...
    pub riscv_sbi: kvm_run__bindgen_ty_1__bindgen_ty_22,
...
fn bindgen_test_layout_kvm_run__bindgen_ty_1__bindgen_ty_22() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<kvm_run__bindgen_ty_1__bindgen_ty_22>())).extension_id
                as *const _ as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<kvm_run__bindgen_ty_1__bindgen_ty_22>())).function_id as *const _
                as usize
        },
        8usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<kvm_run__bindgen_ty_1__bindgen_ty_22>())).args as *const _
                as usize
        },
        16usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<kvm_run__bindgen_ty_1__bindgen_ty_22>())).ret as *const _
                as usize
        },
        64usize,
        concat!(
...
pub const sev_cmd_id_KVM_SEV_NR_MAX: sev_cmd_id = 21;
